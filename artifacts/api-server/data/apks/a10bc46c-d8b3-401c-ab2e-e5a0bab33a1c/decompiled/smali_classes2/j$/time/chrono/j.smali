...
.method public static L(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/f;)Lj$/time/chrono/j;
    .locals 11
    ...
    .line 141
    :cond_0
    invoke-virtual {p0}, Lj$/time/ZoneId;->L()Lj$/time/zone/f;

    move-result-object v0

    .line 142
    invoke-static {p2}, Lj$/time/LocalDateTime;->M(Lj$/time/temporal/TemporalAccessor;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual/range {v1 .. v10}, Lj$/time/chrono/f;->N(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/f;
...
.method public static M(Lj$/time/chrono/Chronology;Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/j;
    .locals 3

    .line 171
    invoke-virtual {p2}, Lj$/time/ZoneId;->L()Lj$/time/zone/f;
    ...
    .line 175
    invoke-interface {p0, p1}, Lj$/time/chrono/Chronology;->x(Lj$/time/LocalDateTime;)Lj$/time/chrono/ChronoLocalDateTime;
...
.method public static k(Lj$/time/chrono/Chronology;Lj$/time/temporal/m;)Lj$/time/chrono/j;
    .locals 1
    ...
    .line 203
    invoke-virtual {p1}, Lj$/time/chrono/j;->getChronology()Lj$/time/chrono/Chronology;
...
.method public final synthetic A(Lj$/time/g;)Ljava/lang/Object;
    ...
    .line 0
    invoke-static {p0, p1}, Lj$/com/android/tools/r8/a;->r(Lj$/time/chrono/ChronoZonedDateTime;Lj$/time/g;)Ljava/lang/Object;
...
.method public final N(JLj$/time/temporal/s;)Lj$/time/chrono/j;
    .locals 1
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/time/chrono/f;->M(JLj$/time/temporal/s;)Lj$/time/chrono/f;

    move-result-object p1

    .line 420
    invoke-virtual {p0}, Lj$/time/chrono/j;->getChronology()Lj$/time/chrono/Chronology;

    move-result-object p2

    .line 190
    invoke-virtual {p1, p0}, Lj$/time/chrono/f;->k(Lj$/time/temporal/m;)Lj$/time/temporal/m;

    move-result-object p1

    .line 420
    invoke-static {p2, p1}, Lj$/time/chrono/j;->k(Lj$/time/chrono/Chronology;Lj$/time/temporal/m;)Lj$/time/chrono/j;
    ...
    invoke-static {v0, p1}, Lj$/time/chrono/j;->k(Lj$/time/chrono/Chronology;Lj$/time/temporal/m;)Lj$/time/chrono/j;
...
.method public final a(JLj$/time/temporal/q;)Lj$/time/temporal/m;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/time/chrono/f;->O(JLj$/time/temporal/q;)Lj$/time/chrono/f;
    ...
    invoke-static {p2, p3, p1}, Lj$/time/chrono/j;->L(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/f;)Lj$/time/chrono/j;
    ...
    .line 453
    invoke-virtual {p2, p1}, Lj$/time/chrono/f;->toEpochSecond(Lj$/time/ZoneOffset;)J

    move-result-wide v0

    invoke-virtual {p2}, Lj$/time/chrono/f;->toLocalTime()Lj$/time/LocalTime;
    ...
    .line 453
    invoke-static {v0, v1, p1, p2}, Lj$/time/Instant;->N(JJ)Lj$/time/Instant;
    ...
    invoke-static {p3, p1, p2}, Lj$/time/chrono/j;->M(Lj$/time/chrono/Chronology;Lj$/time/Instant;Lj$/time/ZoneId;)Lj$/time/chrono/j;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/j;->N(JLj$/time/temporal/s;)Lj$/time/chrono/j;
...
.method public final g(Lj$/time/LocalDate;)Lj$/time/temporal/m;
    ...
    .line 190
    invoke-virtual {p1, p0}, Lj$/time/LocalDate;->k(Lj$/time/temporal/m;)Lj$/time/temporal/m;
...
.method public final getChronology()Lj$/time/chrono/Chronology;
    ...
    .line 265
    invoke-virtual {p0}, Lj$/time/chrono/j;->toLocalDate()Lj$/time/chrono/b;
...
.method public final h(Lj$/time/temporal/q;)Lj$/time/temporal/u;
    ...
    .line 191
    invoke-virtual {v0, p1}, Lj$/time/chrono/f;->h(Lj$/time/temporal/q;)Lj$/time/temporal/u;
...
.method public final s(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    .locals 2
    ...
    invoke-static {p1, v1, v0}, Lj$/time/chrono/j;->L(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/f;)Lj$/time/chrono/j;
...
.method public final toLocalDate()Lj$/time/chrono/b;
    ...
    invoke-virtual {v0}, Lj$/time/chrono/f;->toLocalDate()Lj$/time/chrono/b;
...
.method public final y(Lj$/time/temporal/q;)J
    ...
    invoke-virtual {v0, p1}, Lj$/time/chrono/f;->y(Lj$/time/temporal/q;)J
