...
.method static constructor <clinit>()V
    ...
    invoke-static {v0, v1}, Lj$/time/LocalDateTime;->O(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
...
.method public static M(Lj$/time/temporal/TemporalAccessor;)Lj$/time/LocalDateTime;
    .locals 3
...
.method public static O(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
    .locals 1
...
.method public static P(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    ...
    .line 0
    invoke-static {p0, p1, p2, p3}, Lj$/com/android/tools/r8/a;->C(JJ)J
...
.method public final N(Lj$/time/chrono/ChronoLocalDateTime;)Z
    .locals 4
    ...
    .line 556
    invoke-virtual {v0}, Lj$/time/LocalTime;->X()J
    ...
    invoke-virtual {p1}, Lj$/time/LocalTime;->X()J
...
.method public final Q(JLj$/time/temporal/s;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v4, v2, v3, v1}, Lj$/time/LocalDate;->V(JLj$/time/temporal/s;)Lj$/time/LocalDate;

    move-result-object v1

    iget-object v2, v0, Lj$/time/LocalDateTime;->b:Lj$/time/LocalTime;

    invoke-virtual {v0, v1, v2}, Lj$/time/LocalDateTime;->U(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v1, v6, v7}, Lj$/time/LocalDate;->W(J)Lj$/time/LocalDate;
    ...
    invoke-virtual {v0, v1, v6}, Lj$/time/LocalDateTime;->U(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual/range {v7 .. v16}, Lj$/time/LocalDateTime;->S(Lj$/time/LocalDate;JJJJ)Lj$/time/LocalDateTime;
    ...
    invoke-virtual/range {v0 .. v9}, Lj$/time/LocalDateTime;->S(Lj$/time/LocalDate;JJJJ)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {v5, v3, v4}, Lj$/time/LocalDate;->W(J)Lj$/time/LocalDate;
    ...
    invoke-virtual {v0, v3, v4}, Lj$/time/LocalDateTime;->U(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual/range {v5 .. v14}, Lj$/time/LocalDateTime;->S(Lj$/time/LocalDate;JJJJ)Lj$/time/LocalDateTime;
...
.method public final S(Lj$/time/LocalDate;JJJJ)Lj$/time/LocalDateTime;
    .locals 20
    ...
    .line 1555
    invoke-virtual {v0, v1, v3}, Lj$/time/LocalDateTime;->U(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
...
.method public final T(JLj$/time/temporal/q;)Lj$/time/LocalDateTime;
    ...
    invoke-virtual {p0, v1, p1}, Lj$/time/LocalDateTime;->U(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
    ...
    .line 970
    :cond_0
    invoke-virtual {v1, p1, p2, p3}, Lj$/time/LocalDate;->a0(JLj$/time/temporal/q;)Lj$/time/LocalDate;

    move-result-object p1

    iget-object p2, p0, Lj$/time/LocalDateTime;->b:Lj$/time/LocalTime;

    invoke-virtual {p0, p1, p2}, Lj$/time/LocalDateTime;->U(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
...
.method public final U(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
    .locals 1
...
.method public atZone(Lj$/time/ZoneId;)Lj$/time/ZonedDateTime;
    ...
    .line 293
    invoke-static {p0, p1, v0}, Lj$/time/ZonedDateTime;->L(Lj$/time/LocalDateTime;Lj$/time/ZoneId;Lj$/time/ZoneOffset;)Lj$/time/ZonedDateTime;
...
.method public final f(Lj$/time/temporal/q;)I
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalDate;->f(Lj$/time/temporal/q;)I
...
.method public final g(Lj$/time/LocalDate;)Lj$/time/temporal/m;
    ...
    invoke-virtual {p0, p1, v0}, Lj$/time/LocalDateTime;->U(Lj$/time/LocalDate;Lj$/time/LocalTime;)Lj$/time/LocalDateTime;
...
.method public final h(Lj$/time/temporal/q;)Lj$/time/temporal/u;
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalDate;->h(Lj$/time/temporal/q;)Lj$/time/temporal/u;
...
.method public final bridge synthetic v(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    .locals 0
...
.method public final y(Lj$/time/temporal/q;)J
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalDate;->y(Lj$/time/temporal/q;)J
