...
.method public constructor <init>(Lj$/time/temporal/TemporalAccessor;Lj$/time/format/DateTimeFormatter;)V
    ...
    .line 132
    :cond_0
    sget-object v1, Lj$/time/temporal/r;->b:Lj$/time/g;
    ...
    .line 133
    sget-object v2, Lj$/time/temporal/r;->a:Lj$/time/g;

    invoke-interface {p1, v2}, Lj$/time/temporal/TemporalAccessor;->A(Lj$/time/g;)Ljava/lang/Object;
    ...
    invoke-interface {p1, v5}, Lj$/time/temporal/TemporalAccessor;->c(Lj$/time/temporal/q;)Z
    ...
    .line 164
    invoke-interface {v3, p1}, Lj$/time/chrono/Chronology;->w(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/b;
    ...
    invoke-interface {p1, v7}, Lj$/time/temporal/TemporalAccessor;->c(Lj$/time/temporal/q;)Z
    ...
    invoke-direct {v0, v4, p1, v3, v2}, Lj$/time/format/v;-><init>(Lj$/time/chrono/b;Lj$/time/temporal/TemporalAccessor;Lj$/time/chrono/Chronology;Lj$/time/ZoneId;)V
...
.method public final a(Lj$/time/temporal/q;)Ljava/lang/Long;
    ...
    invoke-interface {v1, p1}, Lj$/time/temporal/TemporalAccessor;->c(Lj$/time/temporal/q;)Z
    ...
    .line 308
    :cond_0
    invoke-interface {v1, p1}, Lj$/time/temporal/TemporalAccessor;->y(Lj$/time/temporal/q;)J
...
.method public final b(Lj$/time/g;)Ljava/lang/Object;
    .locals 4

    .line 287
    iget-object v0, p0, Lj$/time/format/w;->a:Lj$/time/temporal/TemporalAccessor;

    invoke-interface {v0, p1}, Lj$/time/temporal/TemporalAccessor;->A(Lj$/time/g;)Ljava/lang/Object;
