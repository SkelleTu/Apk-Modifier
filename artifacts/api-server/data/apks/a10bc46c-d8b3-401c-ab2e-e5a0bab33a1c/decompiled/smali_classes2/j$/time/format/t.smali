...
.method public constructor <init>(Lj$/time/format/TextStyle;Z)V
    ...
    sget-object v1, Lj$/time/temporal/r;->e:Lj$/time/g;
...
.method public final f(Lj$/time/format/w;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {p1, v0}, Lj$/time/format/w;->b(Lj$/time/g;)Ljava/lang/Object;
    ...
    .line 238
    iget-object v3, p1, Lj$/time/format/w;->a:Lj$/time/temporal/TemporalAccessor;
    ...
    invoke-interface {v3, v5}, Lj$/time/temporal/TemporalAccessor;->c(Lj$/time/temporal/q;)Z
    ...
    .line 4112
    invoke-virtual {v0}, Lj$/time/ZoneId;->L()Lj$/time/zone/f;

    move-result-object v0

    invoke-static {v3}, Lj$/time/Instant;->M(Lj$/time/temporal/TemporalAccessor;)Lj$/time/Instant;
    ...
    .line 4114
    invoke-interface {v3, v8}, Lj$/time/temporal/TemporalAccessor;->c(Lj$/time/temporal/q;)Z
    ...
    .line 4115
    invoke-interface {v3, v5}, Lj$/time/temporal/TemporalAccessor;->y(Lj$/time/temporal/q;)J

    move-result-wide v9

    invoke-static {v9, v10}, Lj$/time/LocalDate;->T(J)Lj$/time/LocalDate;

    move-result-object v5

    .line 4116
    invoke-interface {v3, v8}, Lj$/time/temporal/TemporalAccessor;->y(Lj$/time/temporal/q;)J

    move-result-wide v8

    invoke-static {v8, v9}, Lj$/time/LocalTime;->Q(J)Lj$/time/LocalTime;
    ...
    .line 538
    invoke-static {v8, v9, v10, v11}, Lj$/time/Instant;->N(JJ)Lj$/time/Instant;
