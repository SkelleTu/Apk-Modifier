...
.method public static u(Lj$/time/chrono/b;JJJ)Lj$/time/chrono/b;
    ...
    invoke-interface {p0, p1, p2, v0}, Lj$/time/chrono/b;->b(JLj$/time/temporal/s;)Lj$/time/chrono/b;

    move-result-object p0

    sget-object p1, Lj$/time/temporal/b;->WEEKS:Lj$/time/temporal/b;

    invoke-interface {p0, p3, p4, p1}, Lj$/time/chrono/b;->b(JLj$/time/temporal/s;)Lj$/time/chrono/b;
    ...
    invoke-interface {p0, v2, v3, p1}, Lj$/time/chrono/b;->b(JLj$/time/temporal/s;)Lj$/time/chrono/b;
    ...
    .line 639
    invoke-static {p5, p6, p2, p3}, Lj$/com/android/tools/r8/a;->F(JJ)J
    ...
    .line 642
    invoke-interface {p0, p2}, Lj$/time/chrono/b;->t(Lj$/time/temporal/n;)Lj$/time/chrono/b;
...
# virtual methods
.method public A(Ljava/util/Map;Lj$/time/format/b0;)Lj$/time/chrono/b;
    .locals 7

    .line 536
    sget-object v0, Lj$/time/temporal/a;->YEAR:Lj$/time/temporal/a;

    invoke-interface {p0, v0}, Lj$/time/chrono/Chronology;->m(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    .line 540
    invoke-interface {p0, v0, v2, v2}, Lj$/time/chrono/Chronology;->E(III)Lj$/time/chrono/b;

    move-result-object v0

    sget-object v1, Lj$/time/temporal/b;->MONTHS:Lj$/time/temporal/b;

    invoke-interface {v0, v3, v4, v1}, Lj$/time/chrono/b;->b(JLj$/time/temporal/s;)Lj$/time/chrono/b;

    move-result-object v0

    sget-object v1, Lj$/time/temporal/b;->DAYS:Lj$/time/temporal/b;

    invoke-interface {v0, p1, p2, v1}, Lj$/time/chrono/b;->b(JLj$/time/temporal/s;)Lj$/time/chrono/b;
    ...
    invoke-interface {p0, v1}, Lj$/time/chrono/Chronology;->m(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    invoke-interface {p0, v3}, Lj$/time/chrono/Chronology;->m(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    .line 547
    :try_start_0
    invoke-interface {p0, v0, v1, p1}, Lj$/time/chrono/Chronology;->E(III)Lj$/time/chrono/b;
    ...
    .line 549
    :catch_0
    invoke-interface {p0, v0, v1, v2}, Lj$/time/chrono/Chronology;->E(III)Lj$/time/chrono/b;
    ...
    .line 549
    invoke-interface {p1, p2}, Lj$/time/chrono/b;->t(Lj$/time/temporal/n;)Lj$/time/chrono/b;
...
.method public G(Ljava/util/Map;Lj$/time/format/b0;)Lj$/time/chrono/b;
    .locals 19
    ...
    invoke-interface {v0, v1, v2}, Lj$/time/chrono/Chronology;->d(J)Lj$/time/chrono/b;
    ...
    .line 444
    :cond_0
    invoke-virtual/range {p0 .. p2}, Lj$/time/chrono/a;->y(Ljava/util/Map;Lj$/time/format/b0;)V

    .line 447
    invoke-virtual/range {p0 .. p2}, Lj$/time/chrono/a;->L(Ljava/util/Map;Lj$/time/format/b0;)Lj$/time/chrono/b;
    ...
    .line 456
    invoke-virtual/range {p0 .. p2}, Lj$/time/chrono/a;->A(Ljava/util/Map;Lj$/time/format/b0;)Lj$/time/chrono/b;
    ...
    .line 566
    invoke-interface {v0, v3}, Lj$/time/chrono/Chronology;->m(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    invoke-static {v10, v11, v7, v8}, Lj$/com/android/tools/r8/a;->F(JJ)J
    ...
    invoke-static {v1, v2, v7, v8}, Lj$/com/android/tools/r8/a;->F(JJ)J

    move-result-wide v1

    .line 571
    invoke-interface {v0, v3, v6, v6}, Lj$/time/chrono/Chronology;->E(III)Lj$/time/chrono/b;

    move-result-object v3

    sget-object v6, Lj$/time/temporal/b;->MONTHS:Lj$/time/temporal/b;

    invoke-interface {v3, v10, v11, v6}, Lj$/time/chrono/b;->b(JLj$/time/temporal/s;)Lj$/time/chrono/b;

    move-result-object v3

    sget-object v6, Lj$/time/temporal/b;->WEEKS:Lj$/time/temporal/b;

    invoke-interface {v3, v4, v5, v6}, Lj$/time/chrono/b;->b(JLj$/time/temporal/s;)Lj$/time/chrono/b;

    move-result-object v3

    sget-object v4, Lj$/time/temporal/b;->DAYS:Lj$/time/temporal/b;

    invoke-interface {v3, v1, v2, v4}, Lj$/time/chrono/b;->b(JLj$/time/temporal/s;)Lj$/time/chrono/b;
    ...
    .line 573
    :cond_3
    invoke-interface {v0, v4}, Lj$/time/chrono/Chronology;->m(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    invoke-virtual {v7, v12, v13, v4}, Lj$/time/temporal/u;->a(JLj$/time/temporal/q;)I

    move-result v7

    .line 574
    invoke-interface {v0, v5}, Lj$/time/chrono/Chronology;->m(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    .line 575
    invoke-interface {v0, v9}, Lj$/time/chrono/Chronology;->m(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    invoke-virtual {v8, v12, v13, v9}, Lj$/time/temporal/u;->a(JLj$/time/temporal/q;)I

    move-result v1

    .line 576
    invoke-interface {v0, v3, v7, v6}, Lj$/time/chrono/Chronology;->E(III)Lj$/time/chrono/b;
    ...
    invoke-interface {v3, v5, v6, v1}, Lj$/time/chrono/b;->b(JLj$/time/temporal/s;)Lj$/time/chrono/b;
    ...
    invoke-interface {v1, v4}, Lj$/time/temporal/TemporalAccessor;->f(Lj$/time/temporal/q;)I
    ...
    .line 578
    :cond_4
    invoke-static {v11}, Lj$/time/e;->k(Ljava/lang/String;)V
    ...
    invoke-interface {v3, v5, v6, v8}, Lj$/time/chrono/b;->b(JLj$/time/temporal/s;)Lj$/time/chrono/b;
    ...
    .line 594
    invoke-interface {v3, v5}, Lj$/time/chrono/b;->t(Lj$/time/temporal/n;)Lj$/time/chrono/b;
    ...
    .line 559
    invoke-interface {v0, v3, v6}, Lj$/time/chrono/Chronology;->j(II)Lj$/time/chrono/b;
    ...
    .line 562
    invoke-interface {v0, v3, v1}, Lj$/time/chrono/Chronology;->j(II)Lj$/time/chrono/b;
    ...
    invoke-static {v2, v3, v7, v8}, Lj$/com/android/tools/r8/a;->F(JJ)J
    ...
    .line 606
    invoke-interface {v0, v9, v6}, Lj$/time/chrono/Chronology;->j(II)Lj$/time/chrono/b;

    move-result-object v1

    sget-object v6, Lj$/time/temporal/b;->WEEKS:Lj$/time/temporal/b;

    invoke-interface {v1, v2, v3, v6}, Lj$/time/chrono/b;->b(JLj$/time/temporal/s;)Lj$/time/chrono/b;

    move-result-object v1

    sget-object v2, Lj$/time/temporal/b;->DAYS:Lj$/time/temporal/b;

    invoke-interface {v1, v4, v5, v2}, Lj$/time/chrono/b;->b(JLj$/time/temporal/s;)Lj$/time/chrono/b;
    ...
    invoke-virtual {v7, v11, v12, v5}, Lj$/time/temporal/u;->a(JLj$/time/temporal/q;)I
    ...
    invoke-interface {v5, v6, v7, v1}, Lj$/time/chrono/b;->b(JLj$/time/temporal/s;)Lj$/time/chrono/b;
    ...
    invoke-interface {v1, v3}, Lj$/time/temporal/TemporalAccessor;->f(Lj$/time/temporal/q;)I
    ...
    .line 612
    :cond_e
    invoke-static {v10}, Lj$/time/e;->k(Ljava/lang/String;)V
    ...
    invoke-interface {v5, v6, v7, v4}, Lj$/time/chrono/b;->b(JLj$/time/temporal/s;)Lj$/time/chrono/b;
    ...
    .line 626
    invoke-interface {v4, v5}, Lj$/time/chrono/b;->t(Lj$/time/temporal/n;)Lj$/time/chrono/b;
...
.method public L(Ljava/util/Map;Lj$/time/format/b0;)Lj$/time/chrono/b;
    .locals 7
    ...
    invoke-static {v4, v5}, Lj$/com/android/tools/r8/a;->x(J)I
    ...
    .line 508
    invoke-interface {p0, v2}, Lj$/time/chrono/Chronology;->m(Lj$/time/temporal/a;)Lj$/time/temporal/u;
    ...
    invoke-interface {p0, p2}, Lj$/time/chrono/Chronology;->p(I)Lj$/time/chrono/k;
    ...
    invoke-interface {p0, p2, v4}, Lj$/time/chrono/Chronology;->r(Lj$/time/chrono/k;I)I
    ...
    .line 513
    invoke-interface {p0, p2, v5}, Lj$/time/chrono/Chronology;->j(II)Lj$/time/chrono/b;

    move-result-object p2

    .line 514
    invoke-interface {p2}, Lj$/time/chrono/b;->C()Lj$/time/chrono/k;
    ...
    .line 530
    invoke-interface {p0, p2}, Lj$/time/chrono/Chronology;->m(Lj$/time/temporal/a;)Lj$/time/temporal/u;
...
.method public final q(Lj$/time/chrono/Chronology;)I
    .locals 1
...
.method public x(Lj$/time/LocalDateTime;)Lj$/time/chrono/ChronoLocalDateTime;
    .locals 4

    .line 477
    :try_start_0
    invoke-interface {p0, p1}, Lj$/time/chrono/Chronology;->w(Lj$/time/temporal/TemporalAccessor;)Lj$/time/chrono/b;
    ...
    invoke-interface {v0, p1}, Lj$/time/chrono/b;->B(Lj$/time/LocalTime;)Lj$/time/chrono/ChronoLocalDateTime;
...
.method public y(Ljava/util/Map;Lj$/time/format/b0;)V
    .locals 5
    ...
    .line 491
    invoke-interface {p2, v3, v4, v2}, Lj$/time/chrono/b;->a(JLj$/time/temporal/q;)Lj$/time/chrono/b;
    ...
    invoke-interface {p2, v1, v2, v0}, Lj$/time/chrono/b;->a(JLj$/time/temporal/q;)Lj$/time/chrono/b;
    ...
    invoke-interface {p2, v0}, Lj$/time/temporal/TemporalAccessor;->f(Lj$/time/temporal/q;)I
