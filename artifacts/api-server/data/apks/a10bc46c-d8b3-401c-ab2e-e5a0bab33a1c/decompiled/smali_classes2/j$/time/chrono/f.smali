...
.method public static L(Lj$/time/chrono/Chronology;Lj$/time/temporal/m;)Lj$/time/chrono/f;
    .locals 1
    ...
    invoke-static {v0, p0, p1}, Lj$/time/e;->f(Ljava/lang/String;Ljava/lang/Object;Ljava/lang/Object;)V
...
.method public final synthetic A(Lj$/time/g;)Ljava/lang/Object;
    ...
    .line 0
    invoke-static {p0, p1}, Lj$/com/android/tools/r8/a;->q(Lj$/time/chrono/ChronoLocalDateTime;Lj$/time/g;)Ljava/lang/Object;
...
.method public final M(JLj$/time/temporal/s;)Lj$/time/chrono/f;
    .locals 17
    ...
    invoke-virtual {v0, v1, v2}, Lj$/time/chrono/f;->P(Lj$/time/temporal/m;Lj$/time/LocalTime;)Lj$/time/chrono/f;
    ...
    invoke-virtual {v0, v1, v6}, Lj$/time/chrono/f;->P(Lj$/time/temporal/m;Lj$/time/LocalTime;)Lj$/time/chrono/f;
    ...
    invoke-virtual/range {v7 .. v16}, Lj$/time/chrono/f;->N(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/f;
    ...
    invoke-virtual/range {v0 .. v9}, Lj$/time/chrono/f;->N(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/f;
    ...
    invoke-virtual {v0, v3, v4}, Lj$/time/chrono/f;->P(Lj$/time/temporal/m;Lj$/time/LocalTime;)Lj$/time/chrono/f;
    ...
    invoke-virtual/range {v5 .. v14}, Lj$/time/chrono/f;->N(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/f;
    ...
    invoke-interface {v1, v0, v2, v3}, Lj$/time/temporal/s;->f(Lj$/time/temporal/m;J)Lj$/time/temporal/m;

    move-result-object v1

    invoke-static {v4, v1}, Lj$/time/chrono/f;->L(Lj$/time/chrono/Chronology;Lj$/time/temporal/m;)Lj$/time/chrono/f;
...
.method public final N(Lj$/time/chrono/b;JJJJ)Lj$/time/chrono/f;
    .locals 18
    ...
    .line 345
    invoke-virtual {v0, v1, v3}, Lj$/time/chrono/f;->P(Lj$/time/temporal/m;Lj$/time/LocalTime;)Lj$/time/chrono/f;
    ...
    .line 355
    invoke-virtual {v3}, Lj$/time/LocalTime;->X()J
    ...
    .line 358
    invoke-static {v8, v9, v4, v5}, Lj$/com/android/tools/r8/a;->C(JJ)J
...
.method public final O(JLj$/time/temporal/q;)Lj$/time/chrono/f;
    .locals 2
    ...
    invoke-virtual {v0, p1, p2, p3}, Lj$/time/LocalTime;->Z(JLj$/time/temporal/q;)Lj$/time/LocalTime;

    move-result-object p1

    invoke-virtual {p0, v1, p1}, Lj$/time/chrono/f;->P(Lj$/time/temporal/m;Lj$/time/LocalTime;)Lj$/time/chrono/f;
    ...
    invoke-virtual {p0, p1, p2}, Lj$/time/chrono/f;->P(Lj$/time/temporal/m;Lj$/time/LocalTime;)Lj$/time/chrono/f;
    ...
    invoke-static {v0, p1}, Lj$/time/chrono/f;->L(Lj$/time/chrono/Chronology;Lj$/time/temporal/m;)Lj$/time/chrono/f;
...
.method public final P(Lj$/time/temporal/m;Lj$/time/LocalTime;)Lj$/time/chrono/f;
    .locals 2
    ...
    invoke-static {v0, p1}, Lj$/time/chrono/d;->L(Lj$/time/chrono/Chronology;Lj$/time/temporal/m;)Lj$/time/chrono/b;
...
.method public final bridge synthetic a(JLj$/time/temporal/q;)Lj$/time/temporal/m;
    ...
    .line 100
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/f;->O(JLj$/time/temporal/q;)Lj$/time/chrono/f;
...
.method public final bridge synthetic b(JLj$/time/temporal/s;)Lj$/time/temporal/m;
    ...
    .line 100
    invoke-virtual {p0, p1, p2, p3}, Lj$/time/chrono/f;->M(JLj$/time/temporal/s;)Lj$/time/chrono/f;
...
.method public final bridge synthetic compareTo(Ljava/lang/Object;)I
    ...
    invoke-virtual {p0, p1}, Lj$/time/chrono/f;->D(Lj$/time/chrono/ChronoLocalDateTime;)I
...
.method public final f(Lj$/time/temporal/q;)I
    ...
    invoke-virtual {v0, p1}, Lj$/time/LocalTime;->f(Lj$/time/temporal/q;)I
    ...
    invoke-interface {v0, p1}, Lj$/time/temporal/TemporalAccessor;->f(Lj$/time/temporal/q;)I
    ...
    .line 262
    :cond_1
    invoke-virtual {p0, p1}, Lj$/time/chrono/f;->h(Lj$/time/temporal/q;)Lj$/time/temporal/u;

    move-result-object v0

    invoke-virtual {p0, p1}, Lj$/time/chrono/f;->y(Lj$/time/temporal/q;)J
...
.method public final g(Lj$/time/LocalDate;)Lj$/time/temporal/m;
    ...
    invoke-virtual {p0, p1, v0}, Lj$/time/chrono/f;->P(Lj$/time/temporal/m;Lj$/time/LocalTime;)Lj$/time/chrono/f;
...
.method public final h(Lj$/time/temporal/q;)Lj$/time/temporal/u;
    ...
    invoke-interface {v0, p1}, Lj$/time/temporal/TemporalAccessor;->h(Lj$/time/temporal/q;)Lj$/time/temporal/u;
...
.method public final k(Lj$/time/temporal/m;)Lj$/time/temporal/m;
    ...
    .line 386
    invoke-virtual {p0}, Lj$/time/chrono/f;->toLocalDate()Lj$/time/chrono/b;
...
.method public final synthetic toEpochSecond(Lj$/time/ZoneOffset;)J
    ...
    invoke-static {p0, p1}, Lj$/com/android/tools/r8/a;->t(Lj$/time/chrono/ChronoLocalDateTime;Lj$/time/ZoneOffset;)J
...
.method public final toInstant(Lj$/time/ZoneOffset;)Lj$/time/Instant;
    ...
    .line 453
    invoke-virtual {p0, p1}, Lj$/time/chrono/f;->toEpochSecond(Lj$/time/ZoneOffset;)J
    ...
    .line 453
    invoke-static {v0, v1, v2, v3}, Lj$/time/Instant;->N(JJ)Lj$/time/Instant;
...
.method public final v(Lj$/time/ZoneId;)Lj$/time/chrono/ChronoZonedDateTime;
    .locals 1

    const/4 v0, 0x0

    .line 366
    invoke-static {p1, v0, p0}, Lj$/time/chrono/j;->L(Lj$/time/ZoneId;Lj$/time/ZoneOffset;Lj$/time/chrono/f;)Lj$/time/chrono/j;
...
.method public final y(Lj$/time/temporal/q;)J
    ...
    invoke-interface {v0, p1}, Lj$/time/temporal/TemporalAccessor;->y(Lj$/time/temporal/q;)J
